    ...
    return (
        <>
            <div className="banner2">
                <h5 className="subheading2">Best Book Illustration Team in the UK</h5>
                <h1 className="heading2">Hire the most talented and imaginative illustrators for your book</h1>
